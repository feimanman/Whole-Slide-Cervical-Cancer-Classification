...
def visualize_training_history(history, save_path, start_loc=1):
    ...
    plt.subplot(222)
    train_patch_loss = history['train_patch_loss'].dropna()
    plt.plot(train_patch_loss.index, train_patch_loss, label='train_patch_loss')
    val_patch_loss = history['val_patch_loss'].dropna()
    plt.plot(val_patch_loss.index, val_patch_loss, label='val_patch_loss')
    ...
    plt.plot(val_acc.index, val_acc, label='val_acc')
    plt.legend()

    plt.subplot(224)
    train_patch_acc = history['train_patch_acc'].dropna()
    plt.plot(train_patch_acc.index,train_patch_acc,label='train_patch_acc')
    val_patch_acc = history['val_patch_acc'].dropna()
    plt.plot(val_patch_acc.index,val_patch_acc,label='val_patch_acc')
