...
class GraphConvModel(nn.Module):
    def __init__(self, feat_dim, node_num, assign_ratio, class_num):
        super(GraphConvModel, self).__init__()
        self.class_num = class_num
        assign_dim = node_num
        self.bn = True
        ## conv_block1
        self.conv1 = DenseGraphConv(feat_dim, 4)
        self.conv2 = DenseGraphConv(4, 2)

        # ## diff_pool_block1
        # assign_dim = int(assign_dim * assign_ratio)
        # self.conv1_pool1 = DenseGraphConv(feat_dim, 4)
        # self.conv2_pool1 = DenseGraphConv(4, assign_dim)
        # self.linear_pool1 = nn.Linear(assign_dim + 4, assign_dim)

        ## conv_block2
        self.conv3 = DenseGraphConv(6, 4)
        self.conv4 = DenseGraphConv(4, 2)

        # ## diff_pool_block2
        # assign_dim = int(assign_dim * assign_ratio)
        # self.conv1_pool2 = DenseGraphConv(6, 4)
        # self.conv2_pool2 = DenseGraphConv(4, assign_dim)
        # self.linear_pool2 = nn.Linear(assign_dim + 4, assign_dim)

        ## conv_block3
        self.conv5 = DenseGraphConv(6, 4)
        self.conv6 = DenseGraphConv(4, 2)

        # ## diff_pool_block3
        # assign_dim = int(assign_dim * assign_ratio)
        # self.conv1_pool3 = DenseGraphConv(6, 4)
        # self.conv2_pool3 = DenseGraphConv(4, assign_dim)
        # self.linear_pool3 = nn.Linear(assign_dim + 4, assign_dim)

        self.conv7 = DenseGraphConv(6, 4)
        self.conv8 = DenseGraphConv(4, 2)

        self.linear = nn.Linear(4 * 6, self.class_num)
