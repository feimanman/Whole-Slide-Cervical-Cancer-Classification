...
def train_epoch(cosine_loss,model, loader, device, optimizer,i_fold,save_path,epoch, verbose=False):
    ...
    for batch_idx, (fc_matrixs,fc_matrixs_neg, feature, feature_neg,targets,risks) in enumerate(loader):
        ...
        preds, cosine_similarity_0,cosine_similarity,out_pos_feature, out_neg_feature = model(feature_batch,feature_neg_batch, fc_matrixs_batch,fc_matrixs_neg_batch)
        # print(cosine_similarity)
        distance_0 = 1-cosine_similarity_0
        distance = 1-cosine_similarity
        distance = (distance_0+distance)/2
        # print(targets_batch)
        # targets_batch_neg = 
