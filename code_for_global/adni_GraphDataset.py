...
class GDataset(Dataset):
    def __init__(self, idxs, csv,  node_num):
        ...
        # self.fc_matrix_dot = '/mnt/data/zhangxin/GAT/adni/input_0974'
        # self.fc_matrix_dot = f'/mnt/data/zhangxin/Journal/data_for_global/input_20'
        # self.fc_matrix_dot_neg = f'/mnt/data/zhangxin/Journal/data_for_global/input_-20'
        self.fc_matrix_dot = f'/mnt/data/zhangxin/GAT/input_200_20_real'
        self.fc_matrix_dot_neg = f'/mnt/data/zhangxin/GAT/input_200_-20_real'
        self.csv = csv
        self.idxs = idxs
    ...
    def __getitem__(self, item):
        ...
        fc_matrix_path = os.path.join(self.fc_matrix_dot, dir_name, f'fcmatrix_20_cos.npy')
        fc_matrix_neg_path = os.path.join(self.fc_matrix_dot_neg, dir_name, f'fcmatrix_20_cos.npy')
        ...
        feature_path = os.path.join(self.fc_matrix_dot, dir_name, f'feature_20.npy')
        feature_path_neg = os.path.join(self.fc_matrix_dot_neg, dir_name, f'feature_20.npy')
...
class GTestDataset(Dataset):
    def __init__(self, idxs, csv, node_num):
        ...
        self.fc_matrix_dot = '/mnt/data/zhangxin/GAT/input_200_10_real'
        
        self.fc_matrix_dot_neg = '/mnt/data/zhangxin/GAT/input_200_-10_real'
...
def get_data_loader(i_fold,node_num,bs):
    df = pd.read_csv('data_csv/fold_train_journal.csv')
    df = df.reset_index()
    #print(df.shape)
    if i_fold != 5:
